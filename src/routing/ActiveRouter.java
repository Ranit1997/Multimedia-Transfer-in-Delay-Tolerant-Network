...
public abstract class ActiveRouter extends MessageRouter {
	...
	public Message messageTransferred(String id, DTNHost from) {
		...
		try
		{
			if(id.startsWith("I"))
			{
		     FileOutputStream fos = new FileOutputStream("C:\\Mini_Project\\One Simulator Media\\src\\Game\\"+to+"\\image_data.txt");
		 ...
		 if(getHost()== m.getTo())
		 {
			 ...
			 reconstruction.grayscale(to);
		 }
		}
		 else if(id.startsWith("A"))
			{
			 FileOutputStream fos = new FileOutputStream("C:\\Mini_Project\\One Simulator Media\\src\\Game\\"+to+"\\audio_data.txt");
		     OutputStreamWriter osw=new OutputStreamWriter(fos);
		     BufferedWriter bw=new BufferedWriter(osw);
		     bw.write(data);
		     bw.close();
		     ...
		     audio_reconstruction.reconstruction("C:\\Mini_Project\\One Simulator Media\\src\\Game\\"+to+"\\");
			}
		}
		catch(Exception e)
		{
